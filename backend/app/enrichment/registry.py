...
LAYER_REGISTRY: tuple[LayerDefinition, ...] = (
    ...
    LayerDefinition(
        ...
        description="Text context + visual fusion for speaker/character prediction (JSON)",
        filename="enrichment_LP.json",
        depends_on="L2",
        enricher_module="modules.enrichment.lp_attribution.enricher",
        enricher_class_name="LPAttributionEnricher",
        sublayers=(
            SubLayerDefinition(
                sublayer_id="S1",
                label="Text context (LLM)",
                artifact_filename="S1_text.json",
                enricher_module="modules.enrichment.lp_attribution.sublayers.s1_text_context",
                enricher_class_name="S1TextContextEnricher",
            ),
            SubLayerDefinition(
                sublayer_id="S2",
                label="Visual fusion",
                artifact_filename="S2_visual.json",
                enricher_module="modules.enrichment.lp_attribution.sublayers.s2_visual_fusion",
                enricher_class_name="S2VisualFusionEnricher",
            ),
            SubLayerDefinition(
                sublayer_id="S3",
                label="Attribution fuse",
                artifact_filename="S3_fusion.json",
                enricher_module="modules.enrichment.lp_attribution.sublayers.s3_fusion",
                enricher_class_name="S3FusionEnricher",
            ),
        ),
    ),
    LayerDefinition(
        layer_id="L3",
        label="Gender",
        description="Text, visual, and audio voice gender proposals (JSON)",
        ...
        sublayers=(
            ...
            SubLayerDefinition(
                sublayer_id="S3",
                label="Frame gender",
                artifact_filename="S3_audio.json",
                enricher_module="modules.enrichment.l3_gender.sublayers.s3_audio_voice",
                enricher_class_name="S3AudioVoiceEnricher",
            ),
        ),
    ),
    LayerDefinition(
